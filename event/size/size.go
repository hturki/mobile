...
//
// See the github.com/hturki/mobile/app package for details on the event model.
package size // import "github.com/hturki/mobile/event/size"
...
type Event struct {
	...
	// pixels in a single geom.Pt, from the github.com/hturki/mobile/geom package.
	//
