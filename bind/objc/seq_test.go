...
func TestObjcSeqTest(t *testing.T) {
	runTest(t, []string{
		"github.com/hturki/mobile/bind/testpkg",
		"github.com/hturki/mobile/bind/testpkg/secondpkg",
		"github.com/hturki/mobile/bind/testpkg/simplepkg",
...
func TestObjcSeqBench(t *testing.T) {
	...
	runTest(t, []string{"github.com/hturki/mobile/bind/benchmark"}, "xcodebench", "SeqBench.m", true)
}

// TestObjcSeqWrappers runs ObjC test SeqWrappers.m.
// This requires the xcode command lines tools.
func TestObjcSeqWrappers(t *testing.T) {
	runTest(t, []string{"github.com/hturki/mobile/bind/testpkg/objcpkg"}, "xcodewrappers", "SeqWrappers.m", false)
}
...
func runTest(t *testing.T, pkgNames []string, project, testfile string, dumpOutput bool) {
	...
	if _, err := run("which gomobile"); err != nil {
		...
		if _, err := run("go install github.com/hturki/mobile/cmd/gomobile"); err != nil {
